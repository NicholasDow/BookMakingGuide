...
You can simplify the git add commit and push to one line with this:
```
function lazygit() {
    git add .
    git commit -a -m "$1"
...
```
Copy this and paste it into your terminal with `Shift + Insert`

You need to do this file manipulation because travis does not activate until it sees you push a .travis.yml file. This is the indicator that the service looks for. 
