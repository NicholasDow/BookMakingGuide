...
--------------------
## Intro Questions
**Questions 1**: A "die", the singular of dice, is a cube with six faces numbered *1*,
*2*, *3*, *4*, *5*, and *6*. What is the chance of getting *1* when
rolling a die

** Solution 1**: If the die is
...
**Questions 2**: What is the chance of getting a *1* or *2* in the next
roll
...
**Questions 3**: What is the chance of getting either *1*, *2*, *3*, *4*, *5*, or *6* on
the next roll
 

** Solution 3**: 100%. The outcome must be one of these numbers.

**Questions 4**: What is the chance of not rolling a *2*
 
** Solution 4**: Since the chance of rolling a *2* is $1/6$ or
...
**Questions 5**: Consider rolling two dice. If $1/6^{th}$ of the time the first die is a
*1* and $1/6^{th}$ of those times the second die is a *1*, what is the
chance of getting two *1*s
 
** Solution 5**: If $16.\bar{6}$% of the time the first die is a *1*
...
*none*, *small*, and *big* disjoint
 
 (b) Determine the proportion of
...
less than *12*. (a) What does the event $A^c$ represent
...
Practice {reference-type="ref"
reference="probDiedIfNotInoculated"}
