...
git:
  submodules: false
```
so that travis does not clone the submodules.
...
First add `rmd_subdir: ["stat545/", "ModernDive_book/"]` so that these directories are searchable. 

Then add the name of the file you want to add to the chapter to the list of rmd_files.
